...
const Dashboard = ({ quotations, items, customers, navigate }) => {
  // State for chart month/year selection
  ...
  const selectedMonthName = new Date(selectedYear, selectedMonth).toLocaleDateString('id-ID', { month: 'long', year: 'numeric' });
        ...
        <div className="section-header">
          <div className="section-title-container">
            <h2>
              ...
              Grafik Penawaran Bulan {selectedMonthName}
            </h2>
            <span className="section-subtitle">Jumlah penawaran yang dibuat per tanggal dalam bulan terpilih</span>
          </div>
